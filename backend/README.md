...
## Project Structure
    ...
    ├── tst_android_deploy_1  # Django project configurations
...
1. Clone this repo and `cd tst_android_deploy_1`
...
2. Clone this repo and `cd tst_android_deploy_1`
